...
<section>
    ...
    <div id="sidebar">
        ...
        <ul id="cats">
            <li><a href="#">Total Items:   <?php  totalitem(); ?> </a></li>
             <li><a href="#">  </a></li>
    ...
    if(isset($_GET['pro_id'])){
      ...
      $prod_id =$_GET['pro_id'];
      $get_pro = "select * from product where p_id='$prod_id'";
    ...
    while($row_pro= mysqli_fetch_array($run_pro)){
        ...
        <div id='singlepro'>
        <h4> $p_title </h4>
        <img src ='img/$p_img' width ='400' height='300'/>
        <table border='1px' style='text-align:left ;padding:5px'>
        <tr>
            <td>Price :
            <td>  <h5> RM $p_price.00 </h5>
        </tr>
        <td> Description:
        <td> <h5> $p_desc</h5>
